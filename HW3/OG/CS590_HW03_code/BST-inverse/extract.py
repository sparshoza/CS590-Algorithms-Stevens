...
final_directory = os.path.join(current_directory, 'BST-inverse-extracted')
if not os.path.exists(final_directory):
   os.makedirs(final_directory)
for i in m:
    filename2 = 'BST-inverse-'+ str(i) +'.txt'
    ...
    filename = 'BST-inverse'+ str(i) +'-extracted.txt'
    with open('BST-inverse-extracted/'+filename, 'w') as z:
