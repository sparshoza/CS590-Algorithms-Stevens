...
final_directory = os.path.join(current_directory, 'RBT-Random-extracted')
if not os.path.exists(final_directory):
   os.makedirs(final_directory)
for i in m:
    filename2 = 'RBT-Random-'+ str(i) +'.txt'
    ...
    filename = 'RBT-Random'+ str(i) +'-extracted.txt'
    with open('RBT-Random-extracted/'+filename, 'w') as z:
