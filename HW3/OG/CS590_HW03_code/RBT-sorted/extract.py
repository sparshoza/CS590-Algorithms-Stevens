...
final_directory = os.path.join(current_directory, 'RBT-sorted-extracted')
if not os.path.exists(final_directory):
   os.makedirs(final_directory)
for i in m:
    filename2 = 'RBT-sorted-'+ str(i) +'.txt'
    ...
    filename = 'RBT-sorted'+ str(i) +'-extracted.txt'
    with open('RBT-sorted-extracted/'+filename, 'w') as z:
